...
def _getParams(model):
    ...
    m0=model.kf.initial_state_mean
    s0=model.kf.initial_state_covariance
    return (A,b,C,d,Q,R,m0,s0)
...
def _printParams(model, fn):
    ...
    print("k= %d" %model.k)
    # full parameter set
    (A,b,C,d,Q,R,m0,s0)=model.getParams()
    print("A (trans):")
    tl.printM(A)
    print("Q (trans_v):")
    tl.printM(Q)
